...
private:
    ...
    double _left_encoder, _right_encoder; // Nuevas variables para los encoders
    double _my_distance;                  // Distancia deseada para que el robot pare.
